...
const forecast = (longitude, latitude, callback) => {
    ...
    if (error) {
        ...
        callback('Cannot find the weather for that location. Please choose another.', undefined) 
           ...
           callback(undefined, body.daily.data[0].summary + ' It is currently '+ body.currently.temperature + ' degrees out and there is a ' + body.currently.precipProbability + '% chance of percipitation.')
               }
    })
